...
public class BrickOvenRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<BrickOvenRecipe> {
        ...
        public static final String ID = "brick_ovening";
    }

    public static class Serializer implements RecipeSerializer<BrickOvenRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(PizzasDelight.MOD_ID,"brick_ovening");

        @Override
        public BrickOvenRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        @Override
        public BrickOvenRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
